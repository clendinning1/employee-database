...
const {  } = require('./queries.js');



// 1. View All Departments submenu
function viewDepartments() {
    // return "department" table... write this in sql as "DESCRIBE department" i think?
    // make sure it shows all columns of the table
}


// 2. View All Roles submenu
function viewRoles() {
    // return "roles" table, same as above
}


// 3. View Employees submenu
function viewEmployees() {
    // return "employees" table, same as above
}
