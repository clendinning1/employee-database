...
async function pullDepartmentsFunct() {
    ...
    const [results, data] = await db.query(pullDepartmentsQuery);
...
// has to be an async function so the await pullDepartmentsFunct works
const addRolePrompt = [
    {
        type: 'input',
    ...
    //     choices: ["manufacturing", "customer service", "quality control"],
    //     // await pullDepartmentsFunct(),
    //     //when(answers) {
    //     //    // return answers.task === 'Um IDK';
...
const addEmployeePrompt = [
    ...
    },
    {
        ...
        choices: ["line operator", "floor lead", "phone operator", "supervisor", "product inspector"],
    },
    {
        type: 'list',
        ...
        choices: ["val jones", "edward elfman", "reggie dwight"],
    },
]
...
const updateEmployeePrompt = [
    {
        ...
        choices: ["gerald richardson", "victoria watters", "jonathan archer", "alejandro cortez", "val jones", "jessica bateman", "david smith", "edward elfman", "reggie dwight"],
    },
    {
        type: 'list',
